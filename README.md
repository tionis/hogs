...
| `HOGS_SERVER_CONSTRAINT_MAX_PRIORITY` | `99` | Highest priority permitted for server-scoped constraints. Instance constraints above this value cannot be overridden by server exemptions. |
